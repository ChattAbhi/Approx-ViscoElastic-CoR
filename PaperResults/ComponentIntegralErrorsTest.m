function ComponentIntegralErrorsTest
addpath ../
alp=3/2; 
...
for i=1:length(bet)
    ...
    for j=1:length(the)
        ...
        Mstore(1,j)=M;
        Mstore(2,j)=Mapprox(alp,bet(i),the(j),'comb');
        Mstore(3,j)=Mapprox(alp,bet(i),the(j),'cheb');
        Mstore(4,j)=Mapprox(alp,bet(i),the(j),'ep');
...
% savefig(strcat(prefixA,'JmaxRelErr.fig'));
% print(strcat(prefixB,'JmaxRelErr.pdf'),'-dpdf');
% 
% figure('Color','w')
% semilogy(bet,maxRelErr(1,:),'-b','LineWidth',2); 
% hold on 
% semilogx(bet,maxRelErr(2,:),'--g','LineWidth',2);
% legend('J_{\alpha,\beta} (\theta)','cubic','Interpreter','latex','FontSize',16)
% title('Max. Relative Error of $J_{\alpha,\beta}(\theta)$ w.r.t. $\beta$','Interpreter','latex','FontSize',16)
% ylabel('Max. Relative Error, $J_{\alpha,\beta}(\theta)$','Interpreter','latex','FontSize',16)
% xlabel('$\beta$','Interpreter','latex','FontSize',16)
% savefig(strcat(prefixA,'CompJmaxRelErr.fig'));
% print(strcat(prefixB,'CompJmaxRelErr.pdf'),'-dpdf');
% 
% figure('Color','w')
...
% xlabel('$\beta$','Interpreter','latex','FontSize',16)
% savefig(strcat(prefixA,'ImaxRelErr.fig'));
% print(strcat(prefixB,'ImaxRelErr.pdf'),'-dpdf');
% 
% figure('Color','w')
% semilogy(bet,maxRelErr(3,:),'-b','LineWidth',2); 
% hold on
...
% ylabel('Max. Relative Error, $\mathcal{I}(\tilde{g}(\theta))$','Interpreter','latex','FontSize',16)
% xlabel('$\beta$','Interpreter','latex','FontSize',16)
% savefig(strcat(prefixA,'CompImaxRelErr.fig'));
% print(strcat(prefixB,'CompImaxRelErr.pdf'),'-dpdf');
% 
% figure('Color','w')
...
% xlabel('$\beta$','Interpreter','latex','FontSize',16)
% savefig(strcat(prefixA,'MmaxRelErr.fig'));
% print(strcat(prefixB,'MmaxRelErr.pdf'),'-dpdf');
% 
figure('Color','w')
semilogy(bet,maxRelErr(5,:),'-b','LineWidth',2); 
hold on
...
legend('Old','Method I (20 pts)','Method II ')
...
% xlabel('$\beta$','Interpreter','latex','FontSize',16)
% savefig(strcat(prefixA,'QmaxRelErr.fig'));
% print(strcat(prefixB,'QmaxRelErr.pdf'),'-dpdf');
